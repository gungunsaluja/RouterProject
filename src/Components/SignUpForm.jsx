...
const SignUpForm = ({ setIsLoggedIn }) => {
  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler} action = "" className = "mt-4 flex flex-col gap-y-3">
        ...
        <div className=" flex">
          <label className="w-full relative">
            ...
            <input
              ...
              className='bg-black rounded-[0.5rem] text-white w-full px-[12px] py-[8px] mt-6'
            />
            <span className = 'absolute right-3 top-[57px] cursor-pointer'
          ...
          <label className="w-full relative">
            ...
            <input
              ...
              className='bg-black rounded-[0.5rem] text-white w-full p-[9px] mt-6'
            />
            <span className="absolute right-3 top-[57px] cursor-pointer" onClick={() => setShowConfirmPassword((prev) => !prev)}>
              {
